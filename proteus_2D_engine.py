...
# Example command: python proteus_2D_engine.py 10000 500 0.00 100.0 0.25 0.25 0.2 0.2 0.4 42 1.0 RC
# The order is python proteus_2D_engine.py N Tmax p density d0 dr cpos cneg c seed RC_factor geometry
...
try:
    ...
    RC_factor = float(sys.argv[11]) # Geometry type (1 for 2D square, >1 for rectangular) (Lx/Ly)
    geometry = sys.argv[12] # Geometry type (SQ for square, RC for rectangular)
except IndexError:
    print("Error: Missing arguments. Usage: python proteus_2D_engine.py N Tmax p density d0 dr cpos cneg c seed "
          "RC_factor geometry")
    sys.exit(1)
