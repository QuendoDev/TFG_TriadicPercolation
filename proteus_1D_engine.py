...
# =============================================================================
# This script expects 9 parameters and the seed initializer
# Example commands:
...
try:
    ...
    print("Usage: python proteus_1D_engine.py N Tmax p density d0 dr cpos cneg c [seed|seed1,seed2|num=X]")
    sys.exit(1)
...
for current_seed in seeds:
    ...
    # Columns represent: [Mean_Cluster1, Std_Cluster1, Mean_Cluster2, Std_Cluster2, Mean_Cluster3, Std_Cluster3]
    # where mean is the position of the center of mass of the cluster and std is the spatial spread or width (std) of
    # the cluster
    ...
    np.savetxt(os.path.join(seed_dir, 'spatial_dyn.txt'), spatial_dyn)
    ...
    del statenodes, RT, spatial_dyn, theta_init
